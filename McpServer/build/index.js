...
"observations": [
  ...
  { "content": "偏好早晨开会", "timestamp": "...", "source": "..." }
]
}
`;
// 工具处理程序
    ...
    return {
        tools: [
                                ...
                                properties: {
                                    ...
                                    observations: {
                                        ...
                                        items: {
                                            type: "object",
                                            properties: {
                                                content: { type: "string", description: "观察内容，应为原子化的单一事实" },
                                    ...
                                    overwrite: { type: "boolean", description: "是否覆盖同名实体，默认为false" }
                                },
                                required: ["name"],
                            },
                        },
                        ...
                        relations: {
                            ...
                            items: {
                                ...
                                properties: {
                                    ...
                                    overwrite: { type: "boolean", description: "是否覆盖相同的源-目标-类型关系，默认为false" }
                                },
            ...
            },
            {
                ...
                description: "向已有实体添加观察项。观察项是关于实体的信息，每条观察应包含单一事实。这个工具可以向多个实体批量添加观察，每条观察可以包含时间戳和来源信息。",
                inputSchema: {
                    type: "object",
                    properties: {
                        observations: {
                            ...
                            items: {
                                ...
                                properties: {
                                    ...
                                    content: { type: "string", description: "观察内容，应该是关于实体的简洁明了的单一信息" },
                    ...
                    properties: {
                        ...
                        observations: {
                            ...
                            items: {
                                type: "object",
                                properties: {
                                    content: { type: "string", description: "观察内容，每项应为原子化的单一事实" },
                                    timestamp: { type: "string", description: "时间戳，记录观察添加的时间" },
                                    source: { type: "string", description: "数据来源，记录观察的来源" },
                                },
                                required: ["content"],
    ...
    try {
        ...
        switch (name) {
            ...
            case "delete_relations":
                ...
                break;
            case "search_nodes":
                result = await makeRequest("GET", `/search?query=${encodeURIComponent(args?.query)}`);
                break;
            ...
            case "get_relation_properties":
                result = await makeRequest("GET", `/relations/${encodeURIComponent(args?.source)}/${encodeURIComponent(args?.target)}/${encodeURIComponent(args?.type)}/properties`);
                break;
            default:
